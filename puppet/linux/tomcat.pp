...
-> file_line { 'Add Tomcat User':
  ...
  line    =>
    "<role rolename=\"manager-gui\"/><role rolename=\"manager-script\"/><user username=\"tomcat\" password=\"$tomcat_password\" roles=\"manager-script,manager-gui\"/></tomcat-users>"
  ,
  match   => '^</tomcat-users>',
  replace => true,
  notify  => Service['tomcat9']
